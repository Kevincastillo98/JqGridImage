# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in myprojectname.
...
base_config.update_blueprint({
    'use_sqlalchemy': True,
    'model': myprojectname.model,
    'DBSession': myprojectname.model.DBSession,
})
...
base_config.update_blueprint({
    ...
    'sa_auth.cookie_secret': "fcb8c7ac-1e5b-496a-a5b1-8040fe1cf37d",
